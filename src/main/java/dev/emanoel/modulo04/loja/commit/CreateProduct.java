package dev.emanoel.modulo04.loja.commit;
...
public class CreateProduct {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        try {
            PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO DimProduct(ProductName, ColorName) VALUES(?, ?)", Statement.RETURN_GENERATED_KEYS);
